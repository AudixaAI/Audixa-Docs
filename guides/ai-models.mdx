---
title: "AI Models"
description: "Compare Base and Advance models to choose the right one for your needs"
---
...
| **Expressiveness** | High Quality & Natural | Highest Quality & Nuanced |
| **Best For** | General applications | Branding, custom experiences |
| **API Parameter** | `"base"` | `"advance"` |
| **Credit Cost** | 1 credit/token | 4 credits/token |
...
```json
{
  "text": "Hello, this is a voice from the Advance model.",
  "voice": "am_ethan",
  "model": "advance",
  "emotion": "happy"
}
...
// Using Advance model with emotion
const advanceAudio = await audixa.generateTTS({
  text: 'Hello from the Advance model!',
  voice: 'am_ethan',
  model: 'advance',
  emotion: 'happy'
});
...
<CardGroup cols={2}>
  ...
  <Card title="Choose Advance If..." icon="star">
