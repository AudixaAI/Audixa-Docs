...
3. **Enter Your Text:** Type or paste your script into the text box.
...
- [**API Introduction:**](/api-reference/introduction) Learn about authentication and the core asynchronous workflow.
- [**Generate Speech (POST /tts):**](/api-reference/tts) Get the full technical details for submitting generation tasks programmatically.