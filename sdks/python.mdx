...
<Tabs>
  ...
  <Tab title="Advanced model codes (ISO 639-1)">
...
| `language_code` | `str` | `None` | Language of the input text. Base model uses single-letter codes (`a`, `b`, `j`, `z`, `e`, `f`, `h`, `i`, `p`); advanced model uses ISO 639-1 (`en`, `de`, `es`, …). See [Language Codes](#language-codes). |
